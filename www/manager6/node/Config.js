        ...
        if (caps.nodes['Sys.Audit']) {
            me.items.push(
                ...
                },
                {
                    ...
                    itemId: 'mem_usage',
                    filterChildItems: ["mem_usage"],
                },
                {
                    title: gettext('Network Traffic'),
                    groups: ['summary'],
                    xtype: 'pveNodeSummary',
                    iconCls: 'fa fa-fw fa-exchange',
                    itemId: 'net_traffic',
                ...
                },
                {
                    ...
                    iconCls: 'fa fa-fw fa-thermometer-half',
                    itemId: 'mem_pressure',
                    filterChildItems: ["mem_pressure"],
                },
                {
                    title: gettext('All Stats'),
                    groups: ['summary'],
                    xtype: 'pveNodeSummary',
