...
<html>
  <head>
    ...
    <title>...[% nodename %] - PVE</title>
    <link rel="icon" sizes="128x128" href="images/favicon.ico" />
    ...
    <link rel="stylesheet" type="text/css" href="https://remove_this_prefix/css/ext6-pve.css?ver=$CACHEBREAKER$" />
